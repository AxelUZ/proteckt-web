      ...
      >
        <div className="mx-auto mb-16 max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-600">
            ...
            ofreciendo soluciones profesionales de control de plagas y
            ayudándolas a cumplir con los requerimientos sanitarios y de
            fumigación.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <ul className="flex w-max animate-marquee gap-8 px-4">
